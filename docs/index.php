...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarsDefault">
    	...
    	<ul class="navbar-nav ml-auto align-items-center">
    		...
    		<a class="nav-link text-danger for-not-logged-in" href="login.php">Log in</a>
    		</li>
    		<li class="nav-item for-not-logged-in">
    		<a class="nav-link text-danger for-not-logged-in" href="register.php">Sign Up</a>
    		</li>
			<li class="nav-item for-logged-in">
    		<a class="nav-link text-danger for-logged-in" href="logout.php">Log out</a>
    		</li>
    		<li class="nav-item for-logged-in">
    		<a class="nav-link for-logged-in" href="profile/user.php"><img class="rounded-circle mr-2" src="assets/img/av.png" width="30"><span class="align-middle">Author</span></a>
    		</li>
